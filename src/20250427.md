...
```
vsoc_x86_64:/ $ test@nuc11test:~$ adb shell
vsoc_x86_64:/ $ dumpsys SurfaceFlinger | grep GLES
GLES: Mesa/X.org, virgl, OpenGL ES 3.2 Mesa 20.3.4 (git-fdb6234126)
vsoc_x86_64:/ $ dumpsys media.player | grep 'hw-' 
      hw-accelerated: 0 ]
      hw-accelerated: 0 ]
      hw-accelerated: 0 ]
      hw-accelerated: 0 ]
...
vsoc_x86_64:/ $ test@nuc11test:~$ adb shell
vsoc_x86_64:/ $ dumpsys SurfaceFlinger | grep GLES
GLES: Google (Intel), Android Emulator OpenGL ES Translator (Mesa Intel(R) Iris(R) Xe Graphics (TGL GT2)), OpenGL ES 3.1 (OpenGL ES 3.2 Mesa 25.2.8-0ubuntu0.24.04.1)
vsoc_x86_64:/ $ 
vsoc_x86_64:/ $ dumpsys media.player | grep 'hw-'
      hw-accelerated: 0 ]
      hw-accelerated: 0 ]
